...
function t() {
    ...
    var D = function () {
            ...
            return t.space = function (e) {
                ...
                if (t) {
                    e = j(t[2], "()"); - 1 < e && (r = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + e, t[2] = t[2].substring(0, e), t[0] = t[0].substring(0, r).trim(), t[3] = "");
                    var n, e = t[2],
                        r = "";
                ...
                if (e) {
                    var n, t = "@" === e[2] ? "mailto:" + (n = U(this.options.mangle ? t(e[1]) : e[1])) : n = U(e[1]);
                    return {
                        type: "link",
                        raw: e[0],
                        text: n,
    ...
    var W = function () {
            ...
            return r.lex = function (e) {
                ...
                if (this.tokens.links) {
                    ...
                    if (0 < c.length)
                        for (; null != (s = this.tokenizer.rules.inline.reflinkSearch.exec(o));) c.includes(s[0].slice(s[0].lastIndexOf("[") + 1, -1)) && (o = o.slice(0, s.index) + "[" + B("a", s[0].length - 2) + "]" + o.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
                }
                ...
                for (; e;)
                ...
                else if (i = this.tokenizer.strong(e, o, a)) e = e.substring(i.raw.length), i.tokens = this.inlineTokens(i.text, [], n, r), t.push(i);
                else if (i = this.tokenizer.em(e, o, a)) e = e.substring(i.raw.length), i.tokens = this.inlineTokens(i.text, [], n, r), t.push(i);
                    ...
                    if (i = this.tokenizer.inlineText(e, r, F)) e = e.substring(i.raw.length), a = i.raw.slice(-1), l = !0, t.push(i);
                    else if (e) {
    ...
    return se.options = se.setOptions = function (e) {
        ...
        var t, n = te({}, a);
        a.renderer && function () {
            var e, l = se.defaults.renderer || new H;
            ...
            var e, l = se.defaults.tokenizer || new D;
