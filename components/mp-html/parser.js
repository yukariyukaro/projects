...
var l = {
        ...
        voidTags: s("card,area,base,br,col,circle,ellipse,embed,frame,hr,img,input,line,link,meta,param,path,polygon,rect,source,track,use,wbr"),
        entities: {
            lt: "<",
            gt: ">",
            quot: '"',
...
r.prototype.parse = function (t) {
    ...
    if ("video" !== i.name && "audio" !== i.name || ("video" !== i.name || e.id || (e.id = "v" + f++), e.controls || e.autoplay || (e.controls = "T"), i.src = [], e.src && (i.src.push(e.src), e.src = void 0), this.expose()), a) {
        ...
        if ("img" === i.name) {
            ...
            "inline" === o.display && (o.display = ""), e.ignore && (o["max-width"] = o["max-width"] || "100%", e.style += ";-webkit-touch-callout:none"), parseInt(o.width) > d && (o.height = void 0), isNaN(parseInt(o.width)) || (i.w = "T"), !isNaN(parseInt(o.height)) && (!o.height.includes("%") || s && (s.attrs.style || "").includes("height")) && (i.h = "T")
        ...
        return e.style = "", e.xmlns = "http://www.w3.org/2000/svg",
            function i(e) {
                ...
                for (var o in e.attrs) {
                    var c = e.attrs[o];
                    c && (h += " ".concat(l.svgDict[o] || o, '="').concat(c, '"'))
                }
                if (e.children) {
                    h += ">";
    ...
    if ((e.class || "").includes("align-center") && (p["text-align"] = "center"), Object.assign(p, this.parseStyle(i)), "table" !== i.name && parseInt(p.width) > d && (p["max-width"] = "100%", p["box-sizing"] = "border-box"), l.blockTags[i.name]) i.name = "div";
        ...
        if ("table" === i.name) {
            ...
            if (i.c && (isNaN(f) && (f = 2), isNaN(g) && (g = 2)), m && (e.style += ";border:".concat(m, "px ").concat(y || "solid", " ").concat(v || "gray")), i.flag && i.c) {
                i.flag = void 0, p.display = "grid", g ? (p["grid-gap"] = g + "px", p.padding = g + "px") : m && (e.style += ";border-left:0;border-top:0");
                var b = [],
                    x = [],
                    w = [],
                    k = {};
                ...
                for (var N = 1; N <= x.length; N++) {
                    for (var T = 1, O = 0; O < x[N - 1].children.length; O++) {
                        var S = x[N - 1].children[O];
                        if ("td" === S.name || "th" === S.name) {
                            for (; k[N + "." + T];) T++;
                            S.c = 1;
                            var C = S.attrs.style || "",
                                j = C.indexOf("width") ? C.indexOf(";width") : 0;
                            if (-1 !== j) {
                                var A = C.indexOf(";", j + 6); - 1 === A && (A = C.length), S.attrs.colspan || (b[T] = C.substring(j ? j + 7 : 6, A)), C = C.substr(0, j) + C.substr(A)
                            }
                            if (C += ";display:flex", -1 !== (j = C.indexOf("vertical-align"))) {
                                var I = C.substr(j + 15, 10);
                                I.includes("middle") ? C += ";align-items:center" : I.includes("bottom") && (C += ";align-items:flex-end")
                            } else C += ";align-items:center";
                            if (-1 !== (j = C.indexOf("text-align"))) {
                                var L = C.substr(j + 11, 10);
                                L.includes("center") ? C += ";justify-content: center" : L.includes("right") && (C += ";justify-content: right")
                            }
                            if (C = (m ? ";border:".concat(m, "px ").concat(y || "solid", " ").concat(v || "gray") + (g ? "" : ";border-right:0;border-bottom:0") : "") + (f ? ";padding:".concat(f, "px") : "") + ";" + C, S.attrs.colspan && (C += ";grid-column-start:".concat(T, ";grid-column-end:").concat(T + parseInt(S.attrs.colspan)), S.attrs.rowspan || (C += ";grid-row-start:".concat(N, ";grid-row-end:").concat(N + 1)), T += parseInt(S.attrs.colspan) - 1), S.attrs.rowspan) {
                                C += ";grid-row-start:".concat(N, ";grid-row-end:").concat(N + parseInt(S.attrs.rowspan)), S.attrs.colspan || (C += ";grid-column-start:".concat(T, ";grid-column-end:").concat(T + 1));
                                for (var z = 1; z < S.attrs.rowspan; z++)
                                    for (var U = 0; U < (S.attrs.colspan || 1); U++) k[N + z + "." + (T - U)] = 1
                            }
                            C && (S.attrs.style = C), w.push(S), T++
                        }
                    }
                    if (1 === N) {
                        for (var q = "", F = 1; F < T; F++) q += (b[F] ? b[F] : "auto") + " ";
