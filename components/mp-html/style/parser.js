...
t.prototype.parse = function (t) {
    ...
    if (!(t.includes("[") || t.includes("*") || t.includes("@"))) {
        ...
        if (t.includes(" ")) {
            ...
            for (var o = t.split(" "), h = 0; h < o.length; h++)
                if (o[h].length)
                    for (var r = o[h].split(">"), l = 0; l < r.length; l++) i.list.push(s(r[l])), l < r.length - 1 && i.list.push(">")
        } else i.key = s(t);
    ...
    if ("/" === t && "*" === this.content[this.i + 1]) return void this.comment();
    if ("{" === t || "," === t || ";" === t) {
        if (this.handler.onSelector(this.selector.trimEnd()), this.selector = "", "{" !== t)
            for (; i[this.content[++this.i]];);
